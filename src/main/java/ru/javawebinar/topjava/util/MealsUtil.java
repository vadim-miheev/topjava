...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(null, LocalDateTime.of(2021, Month.FEBRUARY, 21, 20, 0), "Ужин (user 2)", 410),
            new Meal(null, LocalDateTime.of(2022, Month.JANUARY, 30, 10, 0), "Завтрак (user 2)", 500)
    );
